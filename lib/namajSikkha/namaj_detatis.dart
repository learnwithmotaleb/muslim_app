...
class Nama_DetailsPage extends StatefulWidget {

  Nama_DetailsPage({super.key});
  ...
  @override
  State<Nama_DetailsPage> createState() => _Nama_DetailsPageState();
}

class _Nama_DetailsPageState extends State<Nama_DetailsPage> {
